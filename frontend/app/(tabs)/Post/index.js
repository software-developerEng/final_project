...
import Button from '../../../components/Posting/Button';
...
export default function Posting() {
  ...
  const handleNext = () => {
    if (step === 0) {
      // Proceed to the next image or finish the selection
      ...
      // Save the caption and proceed to the next image or finish posting
      if (imageIndex < images.length - 1) {
        ...
        // Implement your logic to post the images and captions
        alert('Images posted! 🎉');
        setImages([]);
        setCaptions([]);
        setStep(0);
